...
0gchaind tendermint unsafe-reset-all --home $HOME/.0gchain
if curl -s --head curl https://server-5.itrocket.net/testnet/og/og_2024-09-16_1091394_snap.tar.lz4 | head -n 1 | grep "200" > /dev/null; then
  curl https://server-5.itrocket.net/testnet/og/og_2024-09-16_1091394_snap.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.0gchain
    else
