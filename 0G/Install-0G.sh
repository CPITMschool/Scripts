...
read -p "Enter custom port prefix (e.g. 26): " OG_PORT
...
curl https://server-3.itrocket.net/testnet/og/og_2025-05-25_858889_snap.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.0gchaind/0g-home/0gchaind-home
...
curl https://server-3.itrocket.net/testnet/og/geth_og_2025-05-25_858889_snap.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.0gchaind/0g-home/geth-home/geth

printGreen "Enabling services..."
