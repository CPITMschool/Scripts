...
echo ""
echo -e "${GREEN}Якщо використовуєте скрипт на сервері вперше, ви побачите результат через  2-3 хвилини:${NC}"
echo -e "${GREEN}Якщо вже користувались скриптом,ви побачите результат перевірки приблизно через 1 хвилину:${NC}"
